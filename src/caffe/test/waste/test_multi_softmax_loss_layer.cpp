...
class MultiSoftmaxWithLossLayerTest : public ::testing::Test
{
  typedef TypeParam Dtype;
 protected:
  MultiSoftmaxWithLossLayerTest() : blob_bottom_0_(new Blob<Dtype>()), blob_top_(new Blob<Dtype>())
  {
...
TYPED_TEST_CASE(MultiSoftmaxWithLossLayerTest, myTypes);
