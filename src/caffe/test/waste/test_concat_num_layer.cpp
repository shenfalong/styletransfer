...
class ConcatNumLayerTest : public ::testing::Test
{
  typedef TypeParam Dtype;
 protected:
  ConcatNumLayerTest() : blob_bottom_0_(new Blob<Dtype>()), blob_bottom_1_(new Blob<Dtype>()),blob_top_(new Blob<Dtype>())
  {
...
TYPED_TEST_CASE(ConcatNumLayerTest, myTypes);


TYPED_TEST(ConcatNumLayerTest, TestGradient)
{
  typedef TypeParam Dtype;

  LayerParameter layer_param;
  ConcatNumLayer<Dtype> layer(layer_param);
