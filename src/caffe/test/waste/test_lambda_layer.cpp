...
class LambdaLayerTest : public ::testing::Test
{
  typedef TypeParam Dtype;
 protected:
  LambdaLayerTest() : blob_bottom_0_(new Blob<Dtype>()), blob_top_(new Blob<Dtype>())
  {
...
TYPED_TEST_CASE(LambdaLayerTest, myTypes);


TYPED_TEST(LambdaLayerTest, TestGradient)
{
  typedef TypeParam Dtype;

  LayerParameter layer_param;
  LambdaLayer<Dtype> layer(layer_param);
