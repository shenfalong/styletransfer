...
class TrivialLayerTest : public ::testing::Test
{
  typedef TypeParam Dtype;
 protected:
  TrivialLayerTest() : blob_bottom_0_(new Blob<Dtype>()), blob_top_(new Blob<Dtype>())
  {
...
TYPED_TEST_CASE(TrivialLayerTest, myTypes);


TYPED_TEST(TrivialLayerTest, TestGradient)
{
  typedef TypeParam Dtype;

  LayerParameter layer_param;
  TrivialLayer<Dtype> layer(layer_param);
