...
class MaxLossLayerTest : public ::testing::Test
{
  typedef TypeParam Dtype;
 protected:
  MaxLossLayerTest() : blob_bottom_0_(new Blob<Dtype>()), blob_top_(new Blob<Dtype>())
  {
...
TYPED_TEST_CASE(MaxLossLayerTest, myTypes);


TYPED_TEST(MaxLossLayerTest, TestGradient)
{
  typedef TypeParam Dtype;

  LayerParameter layer_param;
  MaxLossLayer<Dtype> layer(layer_param);
