...
class OneHotLayerTest : public ::testing::Test
{
  typedef TypeParam Dtype;
 protected:
  OneHotLayerTest() : blob_bottom_0_(new Blob<Dtype>()), blob_top_(new Blob<Dtype>())
  {
...
TYPED_TEST_CASE(OneHotLayerTest, myTypes);


TYPED_TEST(OneHotLayerTest, TestGradient)
{
  typedef TypeParam Dtype;

  LayerParameter layer_param;
  OneHotLayer<Dtype> layer(layer_param);
