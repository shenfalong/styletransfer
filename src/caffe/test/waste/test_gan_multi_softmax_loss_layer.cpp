...
class GANMultiSoftmaxWithLossLayerTest : public ::testing::Test
{
  typedef TypeParam Dtype;
 protected:
  GANMultiSoftmaxWithLossLayerTest() : blob_bottom_0_(new Blob<Dtype>()), blob_top_(new Blob<Dtype>())
  {
  ...
  virtual ~GANMultiSoftmaxWithLossLayerTest()
  {
...
TYPED_TEST_CASE(GANMultiSoftmaxWithLossLayerTest, myTypes);


TYPED_TEST(GANMultiSoftmaxWithLossLayerTest, TestGradient)
{
  typedef TypeParam Dtype;

  LayerParameter layer_param;
  GANMultiSoftmaxWithLossLayer<Dtype> layer(layer_param);
