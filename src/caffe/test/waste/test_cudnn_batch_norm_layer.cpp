...
class CuDNNBatchNormLayerTest : public ::testing::Test
{
  typedef TypeParam Dtype;
 protected:
  CuDNNBatchNormLayerTest() : blob_bottom_(new Blob<Dtype>()), blob_top_(new Blob<Dtype>())
  {
...
TYPED_TEST_CASE(CuDNNBatchNormLayerTest, myTypes);
