...
class NormalizeLayerTest : public ::testing::Test
{
  typedef TypeParam Dtype;
 protected:
  NormalizeLayerTest() : blob_bottom_(new Blob<Dtype>()), blob_top_(new Blob<Dtype>())
  {
...
TYPED_TEST_CASE(NormalizeLayerTest, myTypes);
