...
class ELULayerTest : public ::testing::Test
{
  typedef TypeParam Dtype;
 protected:
  ELULayerTest() : blob_bottom_(new Blob<Dtype>()), blob_top_(new Blob<Dtype>())
  {
...
TYPED_TEST_CASE(ELULayerTest, myTypes);


TYPED_TEST(ELULayerTest, TestGradient)
{
  typedef TypeParam Dtype;
