...
void SmoothL1LossLayer::Forward_gpu(const vector<Blob*>& bottom, const vector<Blob*>& top) 
{
...
void SmoothL1LossLayer::Backward_gpu(const vector<Blob*>& top, const vector<Blob*>& bottom) 
{
...
void SmoothL1LossLayer::SecForward_gpu(const vector<Blob*>& bottom, const vector<Blob*>& top) 
{
}
